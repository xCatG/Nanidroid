...
object Setup {
    ...
    const val DLG_G_LIST = "ghostlistdialog"
    const val DLG_NOT_IMPL = "notimplementedmsg"
    const val DLG_ABOUT = "aboutdialog"
    const val DLG_E_URL = "enterurldialog"
    const val DLG_ERR = "errormsgdlg"
    const val DLG_NAR_PICK = "narpickdlg"
    const val DLG_MORE_G = "moreghostdlg"
    const val DLG_GEN_HELP = "generalhelpdlg"
