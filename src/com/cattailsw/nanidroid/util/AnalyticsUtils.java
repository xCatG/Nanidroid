...
public class AnalyticsUtils {
    ...
    private static String UACODE = "INSERT_YOUR_ANALYTICS_UA_CODE_HERE";
    ...
    public static AnalyticsUtils getInstance(Context ctx, String uaCode, boolean enableAnalytics) {
	if ( uaCode != null )
	    UACODE = uaCode;
