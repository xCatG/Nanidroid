...
public class NotSupportedShiori extends EchoShiori {
    ...
    public NotSupportedShiori(Context ctx) { mCtx = ctx; }
    public String getModuleName() { return "NotSupportedShiori"; }
    ...
    protected String genResponse() {
        ...
        if (req.equalsIgnoreCase("OnGhostChanged") || req.equalsIgnoreCase("OnFirstBoot") ||
