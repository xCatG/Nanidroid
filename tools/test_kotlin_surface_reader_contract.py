...
class KotlinSurfaceReaderContractTest(unittest.TestCase):
    def test_surface_reader_is_kotlin_and_preserves_ant_overlay_source(self):
        ...
        self.assertFalse((root / "src/com/cattailsw/nanidroid/SurfaceReader.java").exists())
        self.assertTrue((root / "legacy/src/com/cattailsw/nanidroid/SurfaceReader.java").exists())
        source = (root / "src/com/cattailsw/nanidroid/SurfaceReader.kt").read_text(encoding="utf-8")
