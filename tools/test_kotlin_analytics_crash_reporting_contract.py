...
class KotlinAnalyticsAndCrashReportingContractTest(unittest.TestCase):
    def test_modern_boundaries_are_kotlin_with_java_visible_entrypoints(self):
        ...
        self.assertFalse(
            (root / "src/main/kotlin/com/cattailsw/nanidroid/util/AnalyticsUtils.java").exists()
        )
        self.assertFalse(
            (root / "src/main/kotlin/com/cattailsw/nanidroid/util/CrashReporting.java").exists()
        )

        analytics = (
            root / "src/main/kotlin/com/cattailsw/nanidroid/util/AnalyticsUtils.kt"
    ...
    def test_current_boundaries_have_no_archived_java_counterparts(self):
        ...
        self.assertFalse((root / "src/main/kotlin/com/cattailsw/nanidroid/util/AnalyticsUtils.java").exists())
